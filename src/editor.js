function getContentCSS() {
    ...
    <style>
        ...
        .x-todo li {list-style:none;}import { size } from 'lodash';
...
function createHTML(options = {}) {
    const {
        backgroundColor = '#F5F6F8', // Editor Background Color
        color = '#000033',
        size = `20px`, // Define your own editor text size
        caretColor = '',
...
<head>
    ...
    <style>
        ...
        * {outline: 0px solid transparent;-webkit-tap-highlight-color: rgba(0,0,0,0);-webkit-touch-callout: none;box-sizing: border-box;}
        ...
        .content {font-family: Arial, Helvetica, sans-serif;color: ${color};font-size:${size}; width: 100%;${
